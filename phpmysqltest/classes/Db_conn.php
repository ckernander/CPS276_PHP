...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'ckernander';//this will be your WCC username
      $dbUsr = 'ckernander';//this will be your WCC username
      $dbPass = 'X9n7FlsAqfgIrQq';//this will be the password found in the video.
